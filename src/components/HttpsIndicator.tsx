...
export const IsHttpIndicator: FC<PropTypes> = ({ isHttp }) => {
  ...
  return (
    <div className="bg-black/5 pl-2 pr-3 py-0.5 rounded-md flex flex-row gap-x-2 mb-3 w-min">
      <LockOpenIcon className="text-black w-5 h-5 pt-0.5" />
      <p className="text-black">https://</p>
    </div>
  );
};
